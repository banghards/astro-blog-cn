...
author: Codex
description: 基于一条关于 Codex、HyperFrame 和 Remotion 的推文，整理成适合公众号阅读的中文文章：视频生产正在从时间线剪辑，转向代码化生成。
source: https://x.com/Saccc_c/status/2051145377865204222
---

# Codex + HyperFrame 正在吃掉视频剪辑的很多工作
...
这对自媒体人、运营人、市场人来说，非常关键。

因为内容生产最怕的，不是做不出一条好视频。

而是每次都从零开始。

![时间线到代码化视频图](./illustrations/02-timeline-to-code.png)
...
![Agent 视频生产流水线图](./illustrations/03-agent-video-pipeline.png)
...
如果你还停留在“每条视频都手工从零剪”，成本会越来越高。

而一旦你掌握代码化视频的基本思路，就可以开始搭自己的视频生产系统。
...
你就已经从“剪一条视频”走向“生成一类视频”了。

## 第四步：让 Codex 帮你迭代

当模板变成代码以后，你就可以让 Codex 介入：
...
![视频生产系统路线图](./illustrations/04-video-system-roadmap.png)
