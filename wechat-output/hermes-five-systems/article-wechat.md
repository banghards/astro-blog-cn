...
# 装完 Hermes 后，最该补齐的 5 套系统，以及它们到底该装在哪里
...
![Hermes 五层系统总览](./illustrations/01-cover-wide.png)
...
![Hermes 五层结构图](./illustrations/02-five-layers.png)
...
![Hermes 记忆层放置方式](./illustrations/03-memory-placement.png)
...
![微信入口层与运行层关系](./illustrations/04-gateway-runtime.png)
